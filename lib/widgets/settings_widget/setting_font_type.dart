...
class SettingFontType extends StatefulWidget {
  final BorderRadius borderRadius;
   ...
   const SettingFontType({Key key, this.borderRadius}) : super(key: key);
  ...
  Widget _buildFontContainer(String name, String font, Size size) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: font == _fontType.toString() ? blue[500] : gray20,
          borderRadius: BorderRadius.circular(15),
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: <Widget>[
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color:
                      font == _fontType.toString() ? Colors.white : blue[500],
                  fontFamily: font,
                  fontSize: 14,
                ),
              ),
