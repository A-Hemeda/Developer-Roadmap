...
void printHello() async {
  ...
  NotificationServices().showNotification(1, "وقت الصلاة الآن",
      "[$now] الوقت =$isolateId ='$printHello'", 3);
}

///TODO Step 1 of 3
partOne()async{
  const int alarmID = 0;
  DateTime nextTimeAlarm = DateTime.parse("2022-08-22 12:26:00.377329");
